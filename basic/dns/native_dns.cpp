...
void reg_native_dns(vm_t* vm) {
	vm_reg_var(vm, CLS_DNS, "A", var_new_str("A"), true);
	vm_reg_var(vm, CLS_DNS, "MX", var_new_str("MX"), true);
	vm_reg_var(vm, CLS_DNS, "NS", var_new_str("NS"), true);
	vm_reg_var(vm, CLS_DNS, "CNAME", var_new_str("CNAME"), true);
