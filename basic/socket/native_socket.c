...
void reg_native_socket(vm_t* vm) {
	...
	vm_reg_static(vm, CLS_SOCKET, "shutdown(fd)", native_socket_shutdown, NULL);
	vm_reg_static(vm, CLS_SOCKET, "connect(fd, host, port, timeout)", native_socket_connect, NULL);
	vm_reg_static(vm, CLS_SOCKET, "bind(fd, host, port)", native_socket_bind, NULL);
	vm_reg_static(vm, CLS_SOCKET, "accept(fd)", native_socket_accept, NULL);
	vm_reg_static(vm, CLS_SOCKET, "listen(fd, backlog)", native_socket_listen, NULL);
	vm_reg_static(vm, CLS_SOCKET, "write(fd, bytes, size)", native_socket_write, NULL);
	vm_reg_static(vm, CLS_SOCKET, "read(fd, bytes, size)", native_socket_read, NULL);
	vm_reg_static(vm, CLS_SOCKET, "setTimeout(fd, timeout)", native_socket_setTimeout, NULL);
}
